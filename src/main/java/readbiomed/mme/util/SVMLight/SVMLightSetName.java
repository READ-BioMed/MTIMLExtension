...
public class SVMLightSetName
{
  ...
  throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException
  {
	if (argc.length != 9)
	{
	  System.err.println("SVMLightSet text_processor parameters feature_extractor parameters category train_file test_file train_svmlight_file test_svmlight_file");
	  System.exit(-1);
	}
    ...
    {
    BufferedWriter w = new BufferedWriter(new FileWriter(argc[7]));
    ...
    {
    BufferedWriter w = new BufferedWriter(new FileWriter(argc[8]));
